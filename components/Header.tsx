...
const Header = () => {
  ...
  return (
    ...
    <header  className='bg-black p-[16px] z-[40] w-full h-[64px] fixed top-0 flex flex-grow gap-[260px] justify-center items-center sm:gap-[450px] xl:gap-[345px] lg:gap-[350px] xl:pl-[201px] xl:pr-[201px]'>
